...
// Firestore client runs the persistent cache means the SDK's pagehide handler shut that client
// down for good, and only a reload recovers — at once, or after asking when an edit is unsaved
