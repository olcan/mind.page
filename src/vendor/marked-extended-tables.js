/* marked-extended-tables v2.0.1 (MIT), https://github.com/calculuschild/marked-extended-tables
   vendored into mind.page unchanged: the package is unmaintained and pins peer marked <16 */
