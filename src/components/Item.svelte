<script lang="ts">
  ...
  function toHTML(
    ...
    // for consistency, also remove all whitespace after <code><pre> open tag
    // one benefit is free spacing between block delimiters and contents
    text = text.replace(/<code><pre>\s+/gs, '<code><pre>')
