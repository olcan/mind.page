<script lang="ts">
  ...
  function onKeyDown(e: any) {
    ...
    // we have to ignore the automated keyups generated by Samsung Keyboard for some reason
    // also note we have no way to detect state of actual shift key, so it could have been toggled off
